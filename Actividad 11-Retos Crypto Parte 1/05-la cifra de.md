...
## Solución:
1. En este reto se nos da el siguiente mensaje: 
...
2. Aparentemente está codificado por el cifrado de cifrado Vigenere. Para resolver esto, se puede utilizar fácilmente la fuerza bruta mediante el uso de herramientas en línea como [esta](https://www.guballa.de/vigenere-solver).
